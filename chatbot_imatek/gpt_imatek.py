...
# ----------------------------------------------------------------
# Función para interpretar mensajes con GPT-4
# ----------------------------------------------------------------
def interpretar_mensaje(historial_gpt):
    """
    Usa GPT-4 para interpretar el mensaje y generar una respuesta.
    """
    try:
        response = openai.ChatCompletion.create(
            model="gpt-4o-mini",
            messages=historial_gpt,
            max_tokens=500,
            temperature=0.7,
...
# ----------------------------------------------------------------
# Función para mantener la conexión activa con OpenAI
# ----------------------------------------------------------------
def mantener_conexion_activa():
    ...
    while True:
        ...
        time.sleep(1800)  # Verifica cada 30 minutos en lugar de cada hora
